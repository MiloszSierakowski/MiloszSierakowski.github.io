$(document).ready(function() {
  const apiRoot = 'https://task-prod-kodilla-tasks-9snr8l.mo4.mogenius.io/v1/tasks';
  const trelloApiRoot = 'https://task-prod-kodilla-tasks-9snr8l.mo4.mogenius.io/v1/trello';
